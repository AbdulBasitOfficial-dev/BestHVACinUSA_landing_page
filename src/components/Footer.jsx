      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 lg:gap-14">
          ...
          <div className="text-center sm:text-left">
            <Link
              to="/"
              className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8 justify-center sm:justify-start"
            >
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 sm:mb-8">
              Your trusted partner for all HVAC needs. We provide reliable
              heating, ventilation, and air conditioning solutions across the
              USA.
            </p>
          ...
          {/* Quick Links */}
          <div className="text-center sm:text-left">
            <h3 className="text-white font-semibold text-base sm:text-lg mb-5 sm:mb-8">
              Quick Links
            </h3>
            ...
            <ul className="space-y-4 sm:space-y-5">
              <li className="flex items-center gap-3 sm:gap-4 justify-center sm:justify-start">
                <a
                  ...
                  className="flex items-center gap-3 sm:gap-4 text-gray-400 hover:text-[#f97316] transition-colors"
                >
