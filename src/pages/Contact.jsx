...
import { FiPhone, FiMail, FiMapPin, FiClock, FiSend, FiUser, FiCheck } from 'react-icons/fi';
import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaSnowflake } from 'react-icons/fa';
...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: FiPhone,
      title: 'Phone',
      value: '+1 (321) 386-0371',
      link: 'tel:+13213860371',
    ...
    },
    {
      icon: FiMail,
      title: 'Email',
      value: 'info@besthvacusa.com',
      link: 'mailto:info@besthvacusa.com',
  ...
  return (
    <div className="bg-[#0a1628]">
      {/* Hero Section */}
      <section className="pt-32 pb-12 md:pt-40 md:pb-16 lg:pt-48 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center">
            <span className="text-[#38bdf8] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block">Contact Us</span>
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-400 leading-relaxed max-w-2xl mx-auto px-4">
              Have questions or need HVAC services? We&apos;re here to help. Reach out anytime.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 ${info.iconBg} rounded-xl flex items-center justify-center mb-4 sm:mb-5`}>
                  <info.icon className={`text-xl sm:text-2xl ${info.iconColor}`} />
                </div>
                <h3 className="text-white font-semibold text-base sm:text-lg mb-1 sm:mb-2">{info.title}</h3>
                {info.link ? (
                  <a href={info.link} className="text-gray-400 text-sm sm:text-base hover:text-white transition-colors break-all">
                    {info.value}
                  </a>
                ) : (
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16">
            {/* Contact Form */}
            <div>
              <span className="text-[#f97316] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block text-center lg:text-left">Send Message</span>
              ...
              {isSubmitted ? (
                <div className="bg-green-900/30 border border-green-500/30 rounded-xl sm:rounded-2xl p-8 sm:p-10 text-center">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Thank You!</h3>
                  <p className="text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base">Your message has been sent. We&apos;ll contact you shortly.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                  <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-300 mb-2 sm:mb-3 block">Your Name *</label>
                    ...
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-300 mb-2 sm:mb-3 block">Email *</label>
                      <div className="relative">
                        <FiMail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-gray-500" />
                        <input
                          type="email"
                          name="email"
                  ...
                  <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-300 mb-2 sm:mb-3 block">Phone</label>
                      <div className="relative">
                    ...
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-300 mb-2 sm:mb-3 block">Service *</label>
                      <div className="relative">
                        ...
                        >
                          <option value="" className="bg-[#0f2744]">Select service</option>
                          {services.map((service) => (
                            <option key={service} value={service} className="bg-[#0f2744]">
                              {service}
                            </option>
                          ))}
                        </select>
                  ...
                  <div>
                    <label className="text-xs sm:text-sm font-medium text-gray-300 mb-2 sm:mb-3 block">Message *</label>
                    <textarea
                      name="message"
            ...
            {/* Right Side */}
            <div>
              <span className="text-[#38bdf8] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block text-center lg:text-left">Our Location</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-5 text-center lg:text-left">
                Serving All of Colorado
              </h2>
              <p className="text-gray-400 mb-8 sm:mb-10 text-sm sm:text-base text-center lg:text-left">
                We provide comprehensive HVAC services throughout Colorado and surrounding areas.
              </p>

              {/* Map */}
              <div className="bg-[#0f2744] border border-white/5 rounded-xl sm:rounded-2xl overflow-hidden mb-8 sm:mb-10">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3105168.9892684747!2d-107.40071799999999!3d39.0119!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x874014749b1856b7%3A0xc75483314990a7ff!2sColorado%2C%20USA!5e0!3m2!1sen!2s!4v1699900000000!5m2!1sen!2s"
                  width="100%"
                  height="280"
                  style={{ border: 0 }}
                  allowFullScreen=""
              ...
              <div className="bg-[#1e3a5f]/50 border border-[#38bdf8]/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-8 sm:mb-10 text-center lg:text-left">
                <h3 className="text-white font-semibold text-lg sm:text-xl mb-2 sm:mb-3">Need Immediate Help?</h3>
              ...
              <div className="text-center lg:text-left">
                <h3 className="text-white font-semibold text-base sm:text-lg mb-4 sm:mb-5">Follow Us</h3>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-[#0f2744]/50 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8 sm:mb-10 text-sm sm:text-base px-4">
            Check out our FAQ or contact us directly. We&apos;re always happy to help!
          </p>
