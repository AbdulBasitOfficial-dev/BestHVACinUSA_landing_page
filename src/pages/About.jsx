  ...
  const values = [
    {
      ...
      title: "Our Mission",
      description:
        "To provide exceptional HVAC services that enhance comfort, improve air quality, and maximize energy efficiency.",
    ...
    },
    {
      ...
      title: "Our Vision",
      description:
        "To be the most trusted HVAC service provider in the USA, known for quality and customer satisfaction.",
  ...
  const milestones = [
    {
      ...
      description: "Started with a vision to provide quality HVAC services.",
    },
    {
      year: "2005",
      title: "Expanded Services",
      description: "Added commercial HVAC solutions to our portfolio.",
    },
    {
      year: "2012",
      title: "10,000 Customers",
      description: "Reached a significant milestone in customer satisfaction.",
    },
    {
      year: "2024",
      title: "Industry Leader",
      description: "Recognized as a top HVAC provider in the USA.",
    },
  ];
  ...
  return (
    <div className="bg-[#0a1628]">
      ...
      >
        ...
        <div className="w-full max-w-6xl mx-auto relative z-10 pt-32 pb-16 md:pt-40 md:pb-20 lg:pt-48">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-10 sm:mb-12 leading-relaxed max-w-3xl mx-auto px-4 drop-shadow-md">
              For over 25 years, BestHVACinUSA has been delivering exceptional
              heating, ventilation, and air conditioning services.
            </p>

            <div className="flex flex-wrap gap-4 sm:gap-5 justify-center px-4">
              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-[#0f2744]/80 backdrop-blur-sm border border-white/10 rounded-xl">
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              <span className="text-[#f97316] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block">
                Our Story
              </span>
              ...
              <p className="text-gray-400 mb-5 sm:mb-6 leading-relaxed text-sm sm:text-base">
                BestHVACinUSA was founded in 1999 with a simple mission: to
                provide honest, reliable, and high-quality HVAC services to our
                community. What started as a small family business has grown
                into one of the most trusted HVAC service providers in the USA.
              </p>
              <p className="text-gray-400 mb-5 sm:mb-6 leading-relaxed text-sm sm:text-base">
                Our journey has been defined by our unwavering commitment to
                customer satisfaction, continuous learning, and adoption of the
                latest HVAC technologies.
              </p>
              <p className="text-gray-400 mb-8 sm:mb-10 leading-relaxed text-sm sm:text-base">
                Today, we continue to set the standard for HVAC excellence,
                offering comprehensive services from installation and
      ...
      <section className="py-16 sm:py-20 md:py-28 bg-[#0f2744]/50 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <span className="text-[#38bdf8] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block">
              What Drives Us
            </span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
            {values.map((value, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 mx-auto mb-5 sm:mb-6 rounded-xl ${value.iconBg} flex items-center justify-center`}
                >
                  <value.icon
                    className={`text-2xl sm:text-3xl md:text-4xl ${value.iconColor}`}
                  />
                </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={index} className="relative pl-16 sm:pl-20 md:pl-24">
                  ...
                  <div className="bg-[#0f2744] border border-white/5 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8">
                    <span className="text-[#f97316] font-bold text-base sm:text-lg">
                      {milestone.year}
                    </span>
                    <h3 className="text-white font-semibold text-base sm:text-lg mt-1 sm:mt-2 mb-2 sm:mb-3">
                      {milestone.title}
                    </h3>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {team.map((member, index) => (
              ...
              >
                ...
                <p className="text-[#f97316] text-xs sm:text-sm">
                  {member.role}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <span className="text-green-400 text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 sm:mb-4 block">
              Certifications
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white px-4">
              Trusted & Certified
        ...
        <div className="w-full max-w-4xl mx-auto">
          <div className="bg-[#0a1628] border border-white/5 rounded-2xl p-8 sm:p-10 md:p-14 text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed mb-8 sm:mb-10 px-2">
              &quot;BestHVACinUSA has been our go-to HVAC provider for over 10
              years. Their professionalism and commitment to customer
